...
ENC_BASERES = 60  # ENCODER BASE RESOLUTION
...
EXTENDEDRESOLUTION_PERCENT = 99  # PERCENTAGE OF FULL ITERPOLATED ENCODER RESOLUTION
...
buttonin = Pin(0, Pin.IN, Pin.PULL_UP)
